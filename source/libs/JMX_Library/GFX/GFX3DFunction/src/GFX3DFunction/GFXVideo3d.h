...
public:
	...
	{
        return reinterpret_cast<bool(__thiscall *)(CGFXVideo3d *, HWND, void *, int)>(0x008A97F0)( //ECSRO ORI
	...
	{
        return reinterpret_cast<bool(__thiscall *)(CGFXVideo3d *, int a2, int a3)>(0x008A9A20)(this, width, height); //ECSRO ORI
	}
	...
	{
		return *reinterpret_cast<CGFXVideo3d**>(0x0C5DD04) = new CGFXVideo3d; //ECSRO ORI
	}


	static inline CGFXVideo3d* get()
	{
		return *((CGFXVideo3d**)0x0C5DD04); //ECSRO ORI
	}
...
#define g_CD3DApplication (*((CGFXVideo3d **)0x0C5DD04)) //ECSRO ORI
