...
CGFontTexture::CGFontTexture(void)
{
    ...
    reinterpret_cast<void(__thiscall *)(CGFontTexture *)>(0x0064B480)(this); //ECSRO
}
...
void CGFontTexture::SetColorFont(D3DCOLOR color)
{
    reinterpret_cast<void(__thiscall *)(CGFontTexture *, D3DCOLOR)>(0x0064B910)(this, color); //ECSRO
}
...
void CGFontTexture::sub_8B4400(int a1, int a2) {
    reinterpret_cast<void(__thiscall *)(CGFontTexture *, int, int)>(0x0064B940)(this, a1, a2);//ECSRO
}

void CGFontTexture::sub_8B4750(int a2) {
    reinterpret_cast<void(__thiscall *)(CGFontTexture *, int)>(0x0064BA10)(this, a2); //ECSRO
}

std::n_wstring *CGFontTexture::GetText(std::n_wstring *str) const {
    return reinterpret_cast<std::n_wstring *(__thiscall *) (const CGFontTexture *, std::n_wstring *str)>(0x0074db70)(
            this, str);
}
