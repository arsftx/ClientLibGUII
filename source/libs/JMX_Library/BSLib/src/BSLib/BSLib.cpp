...
const GlobalVar<CGfxRuntimeClass, 0x0C5DD60> CObj::classCObj; //ECSRO
...
bool CObj::IsSame(const CGfxRuntimeClass& rtclass) const {
	return reinterpret_cast<bool(__thiscall*)(const CObj*, const CGfxRuntimeClass&)>(0x00898FB0)(this, rtclass); //ECSRO 
}

bool CObj::IsKindOf(const CGfxRuntimeClass& rtclass) const {
	return reinterpret_cast<bool(__thiscall*)(const CObj*, const CGfxRuntimeClass&)>(0x00898FD0)(this, rtclass); //ECSRO 
}
...
int CObjChild::StartTimer(int timerId, int timeoutMs) {
	return reinterpret_cast<int(__thiscall*)(CObjChild*, int, int)>(0x00897570)(this, timerId, timeoutMs); //ECSRO 
}


int CObjChild::KillTimer(int timerId) {
	return reinterpret_cast<int(__thiscall*)(CObjChild*, int)>(0x00897630)(this, timerId); //ECSRO 
}
