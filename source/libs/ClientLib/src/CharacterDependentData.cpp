...
bool CCharacterDependentData::IsInParty() const {
    return reinterpret_cast<bool(__thiscall *)(const CCharacterDependentData *)>(0x007dfb10)(this);
}
...
bool CCharacterDependentData::IsInTrainingCamp() const {
    return reinterpret_cast<bool(__thiscall *)(const CCharacterDependentData *)>(0x007dfbd0)(this);
}
...
const SCharacterStatistics &CCharacterDependentData::FUN_00987090() const {
    return reinterpret_cast<const SCharacterStatistics &(__thiscall *) (const CCharacterDependentData *)>(0x007dfb30)(this);
}

int CCharacterDependentData::FUN_00993120(const std::n_wstring &characterName) const {
    return reinterpret_cast<int(__thiscall *)(const CCharacterDependentData *, const std::n_wstring &)>(0x008288c0)(this, characterName);
}
