...
// ============================================================
// CIObject - ECSRO
// Note: GetLocation() uses direct offset 0x74 because
// class layout in C++ doesn't match native binary layout.
// Use direct memory access for position: *(float*)(obj + 0x74)
// ============================================================
