...
GlobalPtr<CGWndBase, 0x0ED362C> g_CurrentIF_UnderCursor;
...
CICharactor *GetCharacterObjectByID_MAYBE(int uniqueid) {
    return reinterpret_cast<CICharactor *(__cdecl *) (int)>(0x00817610)(uniqueid);
}

std::n_string GetKindredTextureFilePath(char param_1, int param_2) {
    return reinterpret_cast<std::n_string(__cdecl *)(char, int)>(0x007e4c60)(param_1, param_2);
}
...
GameDataExt::GameDataExt()
    : MyJobInfo() {
}


GameDataExt *p_GameData;
