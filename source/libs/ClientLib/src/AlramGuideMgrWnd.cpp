...
CAlramGuideMgrWnd::CAlramGuideMgrWnd() : m_numberOfIcons(0) {
}
...
CGWnd *CAlramGuideMgrWnd::GetGuide(int windowId) {
    ...
    switch (windowId) {
        ...
        // DISABLED: GUIDE_FLORIAN0 has same ID (13378) as GUIDE_MACROBUTTON
        // case GUIDE_FLORIAN0:
        //     pObj = CreateInstance(this, GFX_RUNTIME_CLASS(CIFflorian0Guide), rect, GUIDE_FLORIAN0, 0);
        //     break;

        case GUIDE_MACROBUTTON:
            pObj = CreateInstance(this, GFX_RUNTIME_CLASS(CMacroButton), rect, GUIDE_MACROBUTTON, 0);
            break;

        case GUIDE_RANKINGICON:
            pObj = CreateInstance(this, GFX_RUNTIME_CLASS(CRankingIcon), rect, GUIDE_RANKINGICON, 0);
            break;
