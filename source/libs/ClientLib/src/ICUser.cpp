...
GFX_IMPLEMENT_DYNAMIC_EXISTING(CICUser, 0x0A04490)
...
unsigned char CICUser::GetJobLevel() const {
    //offset 0x6fb
    return reinterpret_cast<unsigned char(__thiscall *)(const CICUser *)>(0x0082c770)(this);
}

//0x6fa
undefined1 CICUser::FUN_009db0d0() {
    return (undefined1) OnMyGetRegJob();
    //return reinterpret_cast<undefined1(__thiscall *)(const CICUser *)>(0x0082c760)(this);
}

BYTE CICUser::OnMyGetRegJob() {

   // printf("%s - GetJobState %d\n", __FUNCTION__, GetJobState());

    if (GetJobState() == TRIJOB_TYPE::TRIJOB_NOJOB)
        return 0;
...
bool CICUser::GetBeginnerState() const {
    return reinterpret_cast<bool(__thiscall *)(const CICUser *)>(0x0082c340)(this);
}

TRIJOB_TYPE CICUser::GetJobState() {
    return MEMUTIL_READ_BY_PTR_OFFSET(this, 0x46d, TRIJOB_TYPE);
    //return reinterpret_cast<TRIJOB_TYPE(__thiscall *)(CICPlayer *)>(0x0081b350)(this);
}

void CICUser::SetJobType(TRIJOB_TYPE NewType) {
    MEMUTIL_WRITE_BY_PTR_OFFSET(this, 0x6fa, TRIJOB_TYPE, NewType);
    MEMUTIL_WRITE_BY_PTR_OFFSET(this, 0x46d, TRIJOB_TYPE, NewType);
}