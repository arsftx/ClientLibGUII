...
GFX_IMPLEMENT_DYNAMIC_EXISTING(CIFTileWnd, 0x009fff54)
...
void CIFTileWnd::TB_Func_12(const char *str, int a3, int a4) {
...
void CIFTileWnd::TB_Func_13(std::n_string str, int a3, int a4) {
    ...
    reinterpret_cast<void(__thiscall *)(CIFTileWnd *, std::n_string, int, int)>(0x0056b170)(this, str, a3, a4);
}
...
void CIFTileWnd::OnCIFReady() {
    reinterpret_cast<void(__thiscall *)(CIFTileWnd *)>(0x0056afc0)(this);
}
...
void CIFTileWnd::sub_81AE00() {
    reinterpret_cast<void(__thiscall *)(CIFTileWnd *)>(0x0056ada0)(this);
}
