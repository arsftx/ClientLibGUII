...
GFX_IMPLEMENT_DYNAMIC_EXISTING(CIFButton, 0x009FE0F8)

GFX_BEGIN_MESSAGE_MAP(CIFButton, CIFWnd)
GFX_END_MESSAGE_MAP()
...
void CIFButton::SetEnabledState(bool state) {
    reinterpret_cast<void(__thiscall *)(CIFButton *, bool)>(0x00535010)(this, state);
}
