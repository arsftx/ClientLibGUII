...
bool CIFChatViewer::OnCreate(long ln) {
   ...
   /* m_WhisperList = m_IRM.GetResObj(GDR_WHISPERLIST, 1);*/
    ...
    // m_Scroll->sub_65A390(v66);  // TODO: Function removed - need correct address for ECSRO
...
int CIFChatViewer::Func_36(int a1, short action, int a3, int a4) {
    if (action <= 0) {
        if (action < 0) {
            // m_Scroll->sub_65A5C0(0);  // TODO: Function removed
        }
    } else {
        // m_Scroll->sub_65A5A0(0);  // TODO: Function removed
    }
...
void CIFChatViewer::UpdateChatSize() {
    ...
    if (m_chatSize) {
        ...
        // m_Scroll->sub_65A500(chatSizeUnit * m_chatSize - 28);  // TODO: Function removed
...
void CIFChatViewer::ActivateTabPage(eTabPage page) {
    ...
    // m_Scroll->sub_65A5C0(999);  // TODO: Function removed
