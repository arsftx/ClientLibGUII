...
{
    reinterpret_cast<void(__thiscall *)(CIFPlayerMiniInfo *)>(0x00689c70)(this);
}

bool CIFPlayerMiniInfo::OnCreateIMPL(long ln) {

    const bool b = reinterpret_cast<bool(__thiscall *)(CIFPlayerMiniInfo *, long)>(0x00688840)(this, ln);
    return b;
}
