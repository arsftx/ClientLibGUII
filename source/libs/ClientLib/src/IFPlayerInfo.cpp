...
GFX_IMPLEMENT_DYNAMIC_EXISTING(CIFPlayerInfo, 0xcafbc4)
...
void CIFPlayerInfo::OnUpdate() {
    ...
    //{
    //    float value1 = g_pCICPlayer->GetIntelligence() * 100.0f;
    //    float value2 = (g_pCICPlayer->GetCurrentLevel() + 7) * 4.0f;
    ...
    //    const SLevelData &levelData = g_CGlobalDataManager->GetLevelData(jobLevel);
    ...
    //        if (g_pCICPlayer->Func_36().Country == 0) {
...
bool CIFPlayerInfo::OnCreateIMPL(long ln) {

    //PutDump("%s - Entered\n", __FUNCTION__);

    bool b = reinterpret_cast<bool(__thiscall *)(CIFPlayerInfo *, long)>(0x00587230)(this, ln);

    return b;
}

void CIFPlayerInfo::OnUpdateIMPL() {
	

	
    reinterpret_cast<void(__thiscall *)(CIFPlayerInfo *)>(0x00587660)(this);

}

void CIFPlayerInfo::RenderMyselfIMPL() {
    reinterpret_cast<void(__thiscall *)(CIFPlayerInfo *)>(0x00534210)(this);
}
